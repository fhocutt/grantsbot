...
def makeGallery():
    ...
    """
    if params['subtype'] in ['intro', 'new_idea', 'ieg_draft',
                             'participants_wanted']:
...
def getFeaturedProfiles():
    ...
    """
    featured_list = []
    profile_page = profiles.Profiles(params[params['subtype']]['input page path'],
                                     params[params['subtype']]['input page id'],
                                     params)
...
def prepOutput(featured_list):
    ...
    output = profiles.Profiles(params[params['subtype']]['output path'],
                               settings = params) #stupid tocreate a new profile object here. and stupid to re-specify the path below
    i = first_subpage
